                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Daftar Purchase Order (PO)</h3>
                            </div>
                            <div class="nk-block-head-content">
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    <button type="button" class="btn btn-outline-primary" onclick="window.location.href='/purchaseOrder'">Tambah</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-inner p-0">
                                    <div class="nk-tb-list">
                                        <div class="nk-tb-item nk-tb-head">
                                            ...
                                            <div class="nk-tb-col"><span>ID PO</span></div>
                                            <div class="nk-tb-col"><span>Nama User</span></div>
                                            <div class="nk-tb-col"><span>Tanggal PO</span></div>
                                            <div class="nk-tb-col"><span>Nama Supplier</span></div>
