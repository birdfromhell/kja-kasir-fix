                                    ...
                                    <table class="table mb-0 table-borderless">
                                        ...
                                        @foreach ($fj as $fjs)
                                            <tr>
                                                ...
                                                <td><strong>{{ $fjs->id_fj }}</strong></td>
                                                <td><strong>{{ $fjs->id_pb }}</strong></td>
                                                <td>{{ $fjs->tanggal_fj }}</td>
                                                <td>
                                                    <button class="btn btn-outline-primary mb-3" data-toggle="modal" data-target="#detailfj{{ $fjs->id_fj }}">
                                                        Detail
                                                    </button>
                                                </td>
                                                <td>{{ $fjs->ket }}</td>
                                                <td>
                                                    <a class="btn btn-outline-primary mb-3" href="/print/faktur/{{ $fjs->id_fj }}/{{ $fjs->id_pb }}">Print</a>
                                                    <div class="modal fade bd-example-modal-xl" id="detailfj{{ $fjs->id_fj }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-xl" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="exampleModalLabel">Detail fj</h5>
